...
"""
# ----------------------------------------------------------------------------------------------------------------------\
tuplex2 = ("Bohr", "Leibniz", "Einstein")
empty = []
variableint = [9, 8, 7, 6, 5, 4, 3, 2, 1, 0]

for element in tuplex2:
    print(element)

empty.append(variableint[2:8])
for element1 in empty:
    print(element1)
